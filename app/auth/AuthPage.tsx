    ...
    return (
      <div className="min-h-[calc(100vh-64px)] flex items-center justify-center">
        ...
        >
          ...
          <h2 className="font-display text-2xl font-bold text-slate-900">Welcome to Edulytics!</h2>
          <p className="text-slate-500 mt-2">Redirecting you to explore schools...</p>
        </motion.div>
      </div>
    )
  }
              ...
              >
                {isSignup && (
                  <div>
                    ...
                    />
                    <p className="text-xs text-slate-400 mt-1">Used as your anonymous identity on reviews</p>
                  </div>
                )}
